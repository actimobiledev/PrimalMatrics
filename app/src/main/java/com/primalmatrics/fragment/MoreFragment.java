...
public class MoreFragment extends Fragment implements CallBacks {

    CoordinatorLayout clMain;



    public static MoreFragment newInstance(boolean b) {
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate (R.layout.fragment_primal_more, container, false);
        initView (rootView);
        initBundle ();
        initData ();
        initAdapter ();
