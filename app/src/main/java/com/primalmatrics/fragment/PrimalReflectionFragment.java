...
import com.primalmatrics.adapter.ReflectionAdapter;
...
public class PrimalReflectionFragment extends Fragment implements CallBacks {
    ...
    public static PrimalReflectionFragment newInstance (boolean b) {
        PrimalReflectionFragment fragment = new PrimalReflectionFragment();
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate (R.layout.fragment_primal_infelaction, container, false);
        initView (rootView);
        initBundle ();
        initData ();
        initAdapter ();
    ...
    private void initAdapter () {
        ...
        reflectionAdapter = new ReflectionAdapter(getActivity (), reflections);
        ...
        rvReflection.addItemDecoration (
                new RecyclerViewMargin(
                        getActivity (),
                        (int) Utils.pxFromDp (getActivity (), 8),
                        (int) Utils.pxFromDp (getActivity (), 8),
                        (int) Utils.pxFromDp (getActivity (), 8),
                        (int) Utils.pxFromDp (getActivity (), 8),
                        1, 0,
