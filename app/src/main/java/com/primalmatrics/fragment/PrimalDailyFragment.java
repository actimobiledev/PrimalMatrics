...
public class PrimalDailyFragment extends Fragment implements CallBacks {

    CoordinatorLayout clMain;



    public static PrimalDailyFragment newInstance(boolean b) {
        PrimalDailyFragment fragment = new PrimalDailyFragment();
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate (R.layout.fragment_primal_daily, container, false);
        initView (rootView);
        initBundle ();
        initData ();
        initAdapter ();
